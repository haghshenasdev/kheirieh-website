...
<head>
  ...
  <meta name="keywords" content="<?php echo $project_data[0]['tags']; ?>"/>
  <meta name="description" content="<?php echo $project_data[0]['description']; ?>"/>
  <meta name="subject" content="<?php echo $project_data[0]['title']; ?>" />
  ...
  <title><?php echo $project_data[0]['title']; ?></title>
</head>
